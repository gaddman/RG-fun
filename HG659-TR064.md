...
Through [extracting the firmware](index.md#Firmware) we get this list of UPNP/TR064 files:
```bash
$ ls etc/upnp/
DevCfg.xml
DevUpg.xml
...
WLANCfg.xml
```
That doesn't include the main upnpdev.xml file. From a scan with nmap [upnp-info](https://nmap.org/nsedoc/scripts/upnp-info.html) script
```sh
...
See remaining XML files at https://gist.github.com/gaddman/9f8bbea5010cdc8cba15a7b76fe655a2
